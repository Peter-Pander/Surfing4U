...
export const glossary = [
  ...
  { term: "Talk story", definition: "To chat about the waves that day, last month, or during that one epic swell in 1987 (or was it ’88?)." },
  { term: "Snake", definition: "Technically, to snake someone is to take off behind them after they’re already riding the wave. However, surfers often use this term to describe someone who cuts them off from the front as well." },
  { term: "Grom, Grommet, or Wahine (female)", definition: "A young surfer, perpetually stoked." },
  { term: "Sponger", definition: "A bodyboarder." },
  { term: "Locals", definition: "The surfers who live nearby and frequent a certain spot. They’re often known for being unfriendly to outsiders." },
  { term: "Goofy", definition: "A goofyfoot is someone who rides with his right foot forward." },
  { term: "Regular", definition: "A regular foot rides with her—you guessed it—left foot forward." },
  { term: "Charge", definition: "To surf particularly well or bravely." },
  { term: "Clean", definition: "Glassy or offshore, generally; when the waves break unimpeded or aided by the wind." },
  { term: "Epic", definition: "When swell, weather, tide and timing synchronize perfectly to create optimal surf." },
  { term: "Macking", definition: "Used to describe especially large and dangerous conditions." },
  { term: "Heavy", definition: "Used to describe a particularly dangerous situation or person." },
  { term: "Pumping", definition: "The act of hopping up and down to gain speed on a wave. Also: a word used to describe when the surf is especially big, consistent and/or clean." },
  { term: "Peeling", definition: "When a wave breaks perfectly left to right or right to left without interruption." },
  { term: "Victory at Sea", definition: "The opposite of glassy. This happens when conditions are so blown out, rough, and disorganized that surfing is nearly impossible." },
  { term: "Mysto", definition: "Anything that defies typical explanation or is shrouded in an air of mystery, usually ascribed to the surf gods." },
  { term: "Pointbreak", definition: "A setup that features waves that break along the shore, rather than toward the shore. Pointbreaks often provide longer rides. Jeffrey’s Bay in South Africa and Rincon in California are classic examples of pointbreaks." },
  { term: "Reefbreak", definition: "A setup featuring waves that break because of underwater reefs. The Pipeline in Oahu and Teahupoo in Tahiti are both reefbreaks." },
  { term: "Beachbreak", definition: "Waves that break at a beach." },
  { term: "Rivermouth", definition: "A setup formed by sand or rock deposits by the outflow of rivers." },
  { term: "Sandbar", definition: "A shallow section caused by the buildup of sand. Sandbars can create great, but often fleeting, conditions at beach breaks." },
  { term: "Hollow", definition: "An adjective used to describe a condition or surf spot where the wave provides barrel sections." },
  { term: "Hurricane", definition: "An especially strong storm system. Called a ‘typhoon’ in Japan and nearby areas and a ‘cyclone’ in Australia and Oceania, hurricanes can create strong, large surf but also cause massive amounts of destruction." },
  { term: "A", definition: "Frame– When a wave breaks at its peak and peels both left and right, providing ample opportunities for surfers headed either way to ride the wave well." },
  { term: "Backing off", definition: "The phenomenon that occurs when a wave moves from shallower to deeper water as it travels towards land. Waves that back off appear as if they will break soon, but then return to a more gradual, gentle slope as they hit a deeper patch of water." },
  { term: "Bowl", definition: "A steep, powerful section of any wave. Waves that create bowl sections also frequently barrel." },
  { term: "Drag", definition: "The amount to which a surfer is slowed down as a result of friction created by his fins, leash, or off-balance stance." },
  { term: "Drive", definition: "A measurement of the force created when the energy of the wave pushes against the surfboard, giving the surfer a boost of speed and power." },
  { term: "Feathering", definition: "Describes the phenomenon just before a wave starts to break, when its lip begins to show whitewater as droplets are separated from the wave by the wind. The stronger the offshore winds, the sooner a wave feathers." },
  { term: "Tube, Barrel, Cave, Keg, Green Room", definition: "The cylindrical area created by a wave breaking. The ultimate move in surfing is to position oneself inside the barrel and ride the wave while it breaks." },
  { term: "Pit Barrel", definition: "When a surfer rides in the barrel, he or she is ‘pitted.’." },
  { term: "Overhead", definition: "Surfers measure wave height in terms of how big the wave is relative to them. Overhead waves are taller than the surfers. Related: ‘knee-high,’ ‘chest-high,’ etc." },
  { term: "Onshore", definition: "When the wind blows from the ocean toward the shore, causing the waves to crumble and become less organized." },
  { term: "Offshore", definition: "When the wind blows out toward the waves, grooming them and allowing them to break in more organized form." },
  { term: "Lineup", definition: "The general area where surfers sit on their boards and wait to catch waves." },
  { term: "Period", definition: "The amount of time in between waves." },
  { term: "Shifty", definition: "Conditions that result in waves breaking in unpredictable locations throughout a lineup." },
  { term: "Tow", definition: "At– The act of using a rope and a jet ski or personal watercraft to pull a surfer at a wave to give him additional speed. Often used for practicing aerials." },
  { term: "Rip, Rip Current or Riptide", definition: "An area of water that rushes from the beach out to sea. Rips present a danger to surfers and swimmers, as they can carry someone out to sea. However, surfers with advanced lineup knowledge may use rip currents to easily access the lineup when the waves are difficult to paddle past." },
  { term: "Spit", definition: "The spray that comes out of a particularly powerful barrel as it closes." },
  { term: "Aerial or Air", definition: "A surfing trick that involves the surfer using the wave as a ramp to launch himself and his board into the air. An aerial is completed when a surfer lands and continues to ride the wave. Also called a punt." },
  { term: "Duckdive", definition: "A maneuver that allows surfers to dive underneath a wave with their boards to avoid getting swept into shore while paddling out into the lineup." },
  { term: "Turtleroll", definition: "A maneuver usually used by surfers with high volume boards that allows them to minimize drag during approaching whitewash by turning upside down with their board." },
  { term: "Turn", definition: "Basic surfing move that involves a surfer changing directions while riding a wave." },
  { term: "Layback", definition: "A surfing maneuver that involves the surfer bending backwards so that his back is on or in the water. To complete a layback, the surfer uses the momentum of the wave to propel himself into an upright position." },
  { term: "Traction Pad", definition: "A foam pad stuck onto the back of the board where surfers place their back foot." },
  { term: "Bodyboard or Boogieboard", definition: "A board that some people choose to ride. It is smaller and made of softer foam; it can be ridden in the prone position or on one’s knees." },
  { term: "Fish", definition: "A style of surfboard design that uses a forked tail and wide nose. Typically, fish designs also feature a thicker, shorter board with less rocker and are used for smaller waves." },
  { term: "Quad", definition: "A fin setup that has gained more popularity lately. Quad setups feature two fins instead of one closest to the tail." },
  { term: "Funboard", definition: "Shorter than a longboard, but longer than a shortboard. Funboards often have rounded edges and small rockers." },
  { term: "Roundtail", definition: "A tail design that involves a gradual rounding out of the surfboard’s contours. Improves speed and drive, but limits maneuverability." },
  { term: "Pintail", definition: "A tail design that involves the end of the surfboard coming to a point. Often used in very large waves, the pintail increases drive and speed." },
  { term: "Squashtail", definition: "A tail design that involves a flat, abrupt end to the surfboard. The rails bend into the tail at almost 90 degrees, creating a chopped look. The corners or the tail, however, are rounded slightly." },
  { term: "Crease", definition: "An area of structural weakness in a board caused by damage it sustains while being used." },
  { term: "Springsuit", definition: "A wetsuit that covers a surfer’s entire torso but not their forearms or calves." },
];
