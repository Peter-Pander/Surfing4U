...
export const glossary = [
  ...
  { term: "Air", definition: "Where the surfer achieves an aerial." },
  ...
  { term: "Carve, Carving", definition: "A manoeuvre or series of manoeuvres where a surfer makes wide, graceful turns on the face of the wave." },
  ...
  { term: "360", definition: "The 360 is a full rotation on the face of the wave. It can be performed either by reversing or carving. In both cases, the surfer spins down the wave. Variations: Reverse 360." },
  ...
  { term: "Air/Aerial", definition: "In surfing, an air is an aerial maneuver in which the surfer gains speed, finds a ramp, launches off the lip, flies above the wave, and lands on the face of the wave or on the flats." },
  { term: "Alley-Oop", definition: "The alley-opp is a backward aerial rotation inspired by skateboarding." },
