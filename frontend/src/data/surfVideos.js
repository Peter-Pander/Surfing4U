const surfVideos = [
  ...
  // New additions would go here, e.g.:
  {
    name: "Blue Crush",
    platform: "Hulu",
    description:
      "An aspiring female surfer trains for a major competition while balancing work, love, and big wave fears.",
    embedUrl: "https://www.youtube.com/embed/xxxxxx",
    type: "Movie",
    recommended: false,
  },
  {
    name: "South Side Stories",
    platform: "Apple TV+",
    description:
      "TV series following surfers tackling the waves in lesser-known breaks around the globe.",
